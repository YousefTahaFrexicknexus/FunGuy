...
#pragma warning restore 0414
        ...
        private InteractionModuleI randomScaleModule;
        ...
        public InteractionModuleEditor(PrefabPainterEditor editor)
        {
            ...
            randomScaleModule = new RandomTransformInteraction(editor);
        }
        ...
        public void OnInspectorGUI()
        {
            ...
            switch (interactionType.enumValueIndex)
            {
                ...
                case (int)InteractionSettings.InteractionType.RandomTransform:
                    randomScaleModule.OnInspectorGUI();
                    break;
        ...
        public void OnSceneGUI()
        {
            ...
            if (brushComponent.DrawBrush(editorTarget.mode, editorTarget.brushSettings, null, out BrushMode brushMode, out RaycastHit raycastHit))
            {
                ...
                switch (interactionType.enumValueIndex)
                {
                    ...
                    case (int)InteractionSettings.InteractionType.RandomTransform:
                        randomScaleModule.OnSceneGUI(brushMode, raycastHit, out applyPhysics);
                        break;
