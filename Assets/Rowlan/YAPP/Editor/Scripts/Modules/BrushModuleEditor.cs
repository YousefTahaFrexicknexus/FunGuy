...
namespace Rowlan.Yapp
{
    ...
    {
        private const string fluentBrushInfo = "Add prefabs: shift + drag mouse"
        ...
        private const string defaultBrushInfo = "Add prefabs: shift + drag mouse"
                + "\nRemove prefabs: shift + ctrl + drag mouse" +
                "\nBrush size: ctrl + mousewheel, Brush rotation: ctrl + shift + mousewheel";
        ...
        SerializedProperty overlapMargin;
        ...
        SerializedProperty fluentRotationStepSize;
        ...
        SerializedProperty poissonDiscDensity;
        ...
        MicroVerseIntegration microVerseIntegration;
...
#pragma warning disable 0414
        ...
        public BrushModuleEditor(PrefabPainterEditor editor)
        {
            ...
            fluentRotationStepSize = editor.FindProperty(x => x.brushSettings.fluentRotationStepDegrees);
            ...
            poissonDiscDensity = editor.FindProperty(x => x.brushSettings.poissonDiscDensity);
            ...
            overlapMargin = editor.FindProperty(x => x.brushSettings.overlapMargin);
            ...
            microVerseIntegration = new MicroVerseIntegration(editor);
        ...
        public void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(overlapMargin, new GUIContent("Overlap Margin", "Margin around the brush for overlap check. Can be negative. Independent of the Allow Overlap flag. Default is 0. Mainly used in Fluent mode"));
            ...
            switch (editorTarget.brushSettings.distribution)
            {
                ...
                case BrushSettings.Distribution.Fluent:
                    EditorGUI.indentLevel++;
                    EditorGUILayout.PropertyField(fluentRotationStepSize, new GUIContent("Rotation Step Degrees", "The degrees per mouse wheel rotation step"));
                    EditorGUI.indentLevel--;
                    break;
                case BrushSettings.Distribution.Poisson_Any:
                    ...
                    EditorGUILayout.PropertyField(poissonDiscDensity, new GUIContent("Density", "Control percentage of poisson discs that are used for painting"));
                    EditorGUI.indentLevel--;
                    break;
            ...
            switch (editorTarget.brushSettings.spawnTarget)
            {
                ...
                */
                ...
                case BrushSettings.SpawnTarget.MicroVerseTrees:
                    microVerseIntegration.OnInspectorGUI();
                    break;
            }
        }
        ...
        public void OnSceneGUI()
        {
            ...
            if ( brushComponent.DrawBrush(editorTarget.mode, editorTarget.brushSettings, brushDistribution, out BrushMode brushMode, out RaycastHit raycastHit))
            {
                switch( brushMode)
                {
            ...
            if ( IsFluent())
            {
                guiInfo = fluentBrushInfo;
            }
            else
            {
                guiInfo = defaultBrushInfo;
            }
        ...
        private void AddPrefabs(RaycastHit hit)
        {
            ...
            switch (editorTarget.brushSettings.distribution)
            {
                ...
                case BrushSettings.Distribution.Fluent:
                    ...
                    break;
                case BrushSettings.Distribution.Poisson_Any:
                    brushDistribution.AddPrefabs_Poisson_Any(hit.point, hit.normal, editorTarget.brushSettings.poissonDiscsRandomized, editorTarget.brushSettings.poissonDiscDensity, editorTarget.brushSettings.overlapMargin);
                    break;
                case BrushSettings.Distribution.Poisson_Terrain:
                    brushDistribution.AddPrefabs_Poisson_Terrain(hit.point, hit.normal, editorTarget.brushSettings.poissonDiscsRandomized, editorTarget.brushSettings.poissonDiscDensity, editorTarget.brushSettings.overlapMargin);
                    break;
                /*
                case BrushSettings.Distribution.FallOff:
            ...
            switch (editorTarget.brushSettings.spawnTarget)
            {
                ...
                */
                ...
                case BrushSettings.SpawnTarget.MicroVerseTrees:
                    ...
                    microVerseIntegration.RemovePrefabs(raycastHit);
        ...
        public void PersistPrefab(PrefabSettings prefabSettings, PrefabTransform prefabTransform)
        {
            switch (editorTarget.brushSettings.spawnTarget)
            {
                ...
                case BrushSettings.SpawnTarget.TerrainTrees:
                    ...
                    unityTerrainTreesIntegration.AddNewPrefab(prefabSettings, prefabTransform.position, prefabTransform.rotation, prefabTransform.scale, editorTarget.brushSettings.overlapMargin);
                ...
                */
                ...
                case BrushSettings.SpawnTarget.MicroVerseTrees:
                    ...
                    microVerseIntegration.AddNewPrefab(prefabSettings, prefabTransform.position, prefabTransform.rotation, prefabTransform.scale, editorTarget.brushSettings.overlapMargin);
