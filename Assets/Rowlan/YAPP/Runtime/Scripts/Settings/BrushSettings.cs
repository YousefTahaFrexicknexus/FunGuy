...
namespace Rowlan.Yapp
{
    ...
    public class BrushSettings
    {
        ...
        public enum SpawnTarget
        {
            ...
            [InspectorName("MicroVerse Trees")]
            MicroVerseTrees = 4,
        }
        ...
        /// <summary>
        /// The rotation degree per mousewheel scroll in fluent mode
        /// </summary>
        [Range(0, 360)]
        public int fluentRotationStepDegrees = 10;
        ...
        /// <summary>
        /// Randomize the number of poisson discs that are actually painted
        /// </summary>
        [Range(0,100)]
        ...
        /// <summary>
        /// Additional margin to the overlap check with the brush size. Can be negative
        /// </summary>
        ...
        /// <summary>
        /// Add prototype to terrain if it's missing
        /// </summary>
        public bool autoAddPrototype = true;
        ...
        /// <summary>
        /// Settings for MicroVerse
        /// </summary>
        public MicroVerseSettings microVerse = null;
    }
}
