...
namespace Funguy.MushroomRunner.Editor
{
    public static class MushroomRunnerSceneBootstrapper
    {
        private const string ModuleRoot = "Assets/_Game/Funguy.MushroomRunner";
        ...
        private const string ScenePath = ModuleRoot + "/Scenes/MushroomRunnerGameplay.unity";
        ...
        private static Camera CreateCamera(Scene scene, Transform parent, Transform followTarget, Rigidbody followBody)
        {
        ...
        private static void CreateDeathPlaneResetVolume(
            Scene scene,
            Transform parent,
        ...
        private static void CreateHud(Scene scene, RunScoreService scoreTracker, RunnerMovementMotor movementMotor, out FloatingJoystick joystick, out TouchDashButton dashButton)
        {
