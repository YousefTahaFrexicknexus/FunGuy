...
namespace Funguy.MushroomRunner
{
    ...
    public sealed class BounceAreaGenerationProfile : ScriptableObject
    {
        ...
        private List<BounceSpawnDefinition> mushroomDefinitions = new();
        [SerializeField, Tooltip("Decoration themes that unlock at different score thresholds.")]
        private List<EnvironmentThemeTierDefinition> themeTiers = new();
