...
public sealed class MushroomBounceProfile : ScriptableObject
{
    ...
    float directionalInfluence = 0.45f;
    ...
    BounceSurfaceResponse CreateResponse(Vector3 worldLaunchDirection, in BounceContext context)
    {
    ...
    Vector3 GetSafeLaunchDirection()
    {
