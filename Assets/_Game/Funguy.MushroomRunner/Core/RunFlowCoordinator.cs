...
namespace Funguy.MushroomRunner
{
    ...
    public sealed class RunFlowCoordinator : MonoBehaviour
    {
        ...
        private RunnerCourseStreamer areaStreamer;
        [SerializeField, Tooltip("Optional bridge that resets older BlockSpawner content with the new run loop.")]
        private LegacyEnvironmentResetAdapter legacyEnvironmentResetAdapter;
        ...
        private bool captureInitialPlayerPose = true;
        [SerializeField, Tooltip("If enabled, the first run begins automatically on Start.")]
        private bool initializeRunOnStart = true;
        ...
        public void Configure(
            MushroomRunnerPlayer playerController,
            RunnerCourseStreamer streamer,
            LegacyEnvironmentResetAdapter environmentResetAdapter = null)
        {
        ...
        private void RunInternal(bool isStartEvent)
        {
            CacheSpawnPoseIfNeeded();
            ...
            RunLifecycleEvent lifecycleEvent = new(
                player,
                cachedSpawnPosition,
                cachedSpawnRotation,
                resetCount);
