...
{
    public RunScoreSnapshot(int score, int comboHits, float multiplier, bool hasActiveCombo, bool isComboBreakPending, float comboBreakTimeRemainingSeconds, float comboBreakDelaySeconds,
                            bool isAirborne, float currentAirtimeSeconds, float rewardedAirtimeSeconds, bool hasQualifiedAirtime, bool hasQualifiedAirtimeMultiplier)
    {
        Score = score;
        ComboHits = comboHits;
