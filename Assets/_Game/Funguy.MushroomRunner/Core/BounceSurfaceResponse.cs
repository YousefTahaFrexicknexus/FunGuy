...
{
    public BounceSurfaceResponse(float velocityScale, float directionalInfluence, float planarBoost, float upwardImpulse, float impactRecoveryFactor,
                                Vector3 launchDirection, float upBlend, bool hasPlanarDragOverride = false, float planarDragOverride = 0f)
    {
