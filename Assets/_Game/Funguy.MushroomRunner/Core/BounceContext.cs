...
{
    public BounceContext(Vector3 incomingVelocity, Vector3 contactPoint, Vector3 contactNormal, Vector3 worldUp, float baseJumpForce, MovementInputFrame inputFrame)
    {
