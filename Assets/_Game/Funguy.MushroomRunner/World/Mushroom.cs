...
public sealed class Mushroom : MonoBehaviour, IBounceSurface, IBounceContactResolver, IBounceSurfaceBehavior
{
    ...
    [Header("Collision")]
    [SerializeField] MeshFilter collisionMeshSource;
    [SerializeField] MeshCollider collisionMeshCollider;
    [Header("Bounce Feel")]
    [SerializeField] bool bounceOnGlancingTouches = true;
    [SerializeField, Range(0f, 0.2f)] float postBounceCollisionIgnoreDuration = 0.08f;
    [Header("Squash")]
    ...
    IEnumerator MushroomSquash(Transform target)
    {
    ...
    MeshFilter ResolveCollisionMeshSource()
    {
    ...
    void DisableOtherColliders(Collider keepCollider)
    {
    ...
    Vector3 ResolveStableBounceNormal(Vector3 worldUp)
    {
