...
namespace Funguy.MushroomRunner
{
    ...
    public sealed class RunScoreService : MonoBehaviour
    {
        ...
        private float airtimeScorePerSecond = 10f;
        ...
        private float lastAirtimeSecondsSample;
        ...
        public RunScoreSnapshot CurrentSnapshot { get; private set; }
        ...
        private void UpdateAirtimeScore(float currentTime)
        {
        ...
        private void SetScore(int nextScore)
        {
