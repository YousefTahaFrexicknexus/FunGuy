    ...
    public class GUIStyles
    {
        ...
        public static GUIStyle ItalicLabelStyle
        {
            get
            {
                ...
                {
                    _italicLabelStyle = new GUIStyle("Label");
        ...
        private static GUIStyle _physicsRunningLabelStyle;
        public static GUIStyle PhysicsRunningLabelStyle
        {
            get
            {
                if (_physicsRunningLabelStyle == null)
                {
                    _physicsRunningLabelStyle = new GUIStyle(GUI.skin.box);
                    _physicsRunningLabelStyle.fontStyle = FontStyle.Bold;
                    _physicsRunningLabelStyle.normal.textColor = new Color(0.9f, 0f, 0f, 0.8f); // red tone
                }
                return _physicsRunningLabelStyle;
            }
        }
        ...
        public static Color BrushAddInvalidInnerColor = new Color(0.15f, 0.15f, 0.15f, 0.3f); // grey tone
        public static Color BrushAddInvalidOuterColor = new Color(0.15f, 0.15f, 0.15f, 1f); // grey tone
