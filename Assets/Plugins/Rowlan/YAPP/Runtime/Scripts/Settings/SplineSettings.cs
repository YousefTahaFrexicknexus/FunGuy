...
namespace Rowlan.Yapp
{
    ...
    public class SplineSettings
    {
        ...
        {
            [Tooltip("Random weighted depending on probability settings")]
            Probability = 0,
            [Tooltip("A prefab is placed exactly once, independent of the probability settings")]
            Singular = 1
        }
        ...
        public bool instanceRotationX = true;
        public bool instanceRotationY = true;
        public bool instanceRotationZ = true;
        ...
        public LanePosition lanePosition = LanePosition.Both;
        ...
        /// <summary>
        /// The selection mode of the prefabs, eg weighted random or singular
        /// </summary>
        ...
        public Dictionary<GameObject,Vector3> prefabInstanceScaleMap = new Dictionary<GameObject,Vector3>();
        public Dictionary<GameObject, Quaternion> prefabInstanceRotationMap = new Dictionary<GameObject, Quaternion>();
